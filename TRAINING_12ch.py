...
EQD_X = np.loadtxt('/home/andrea/DEMO/NNET/DEMO_S1_HNC_12ch_10ms_EQD_X.txt')
EQD_Yn = np.loadtxt('/home/andrea/DEMO/NNET/DEMO_S1_HNC_12ch_10ms_EQD_Yn.txt')
DEMO_total_counts = np.loadtxt('/home/andrea/DEMO/NNET/LIE_counts_12.txt')


a = np.linspace(EQD_X[0], 1, 21)

training = sio.loadmat('DEMO_S1_HNC_12ch_10ms_Training.mat')
validation = sio.loadmat('DEMO_S1_HNC_12ch_10ms_Validation.mat')
test = sio.loadmat('DEMO_S1_HNC_12ch_10ms_Test.mat')
...
#
# 
model_filename = "Model_DEMO_12ch.h5"
...
history = model.fit(data_Train_Input_norm, data_Train_Target_norm, 
                   ...
                   epochs=40000, batch_size=40, callbacks=[callback1, callback2])
...
NET_target_norm = model.predict(DEMO_total_counts_norm.reshape(-1, 12))
