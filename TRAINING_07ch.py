...
for i in range(0,3):
    DEMO_total_counts[i]=0
    DEMO_total_counts[i+10]=0
    DEMO_total_counts[i]=0
    DEMO_total_counts[i+10]=0
DEMO_total_counts = np.delete(DEMO_total_counts,0)
DEMO_total_counts = np.delete(DEMO_total_counts,0)
DEMO_total_counts = np.delete(DEMO_total_counts,0)
DEMO_total_counts = np.delete(DEMO_total_counts,7)
DEMO_total_counts = np.delete(DEMO_total_counts,7)
DEMO_total_counts = np.delete(DEMO_total_counts,7)
...
for i in range(0,3):
    data_Test_Input[:,i]=0
    data_Test_Input[:,i+10]=0
    data_Train_Input[:,i]=0
    data_Train_Input[:,i+10]=0
data_Test_Input = np.delete(data_Test_Input,0,1)
data_Test_Input = np.delete(data_Test_Input,0,1)
data_Test_Input = np.delete(data_Test_Input,0,1)
data_Test_Input = np.delete(data_Test_Input,7,1)
data_Test_Input = np.delete(data_Test_Input,7,1)
data_Test_Input = np.delete(data_Test_Input,7,1)

data_Train_Input = np.delete(data_Train_Input,0,1)
data_Train_Input = np.delete(data_Train_Input,0,1)
data_Train_Input = np.delete(data_Train_Input,0,1)
data_Train_Input = np.delete(data_Train_Input,7,1)
data_Train_Input = np.delete(data_Train_Input,7,1)
data_Train_Input = np.delete(data_Train_Input,7,1)

data_Validation_Input = np.delete(data_Validation_Input,0,1)
data_Validation_Input = np.delete(data_Validation_Input,0,1)
data_Validation_Input = np.delete(data_Validation_Input,0,1)
data_Validation_Input = np.delete(data_Validation_Input,7,1)
data_Validation_Input = np.delete(data_Validation_Input,7,1)
data_Validation_Input = np.delete(data_Validation_Input,7,1)
...
model_filename = "Model_DEMO_07ch.h5"
...
NET_target_norm = model.predict(DEMO_total_counts_norm.reshape(-1, 7))
